 ...
 *
 * Provides CSRF protection, state management, approval dialog rendering,
 * and cookie-based client approval tracking.
 */
  ...
  <div class="container">
    ...
    <div class="card">
      ...
      <div class="client-info">
        ...
        ${clientUri ? `<div><a href="${clientUri}" target="_blank" rel="noopener noreferrer">${clientUri}</a></div>` : ""}
      </div>
